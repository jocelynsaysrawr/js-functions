...
console.log("multiplyThenDivide: ", multiplyThenDivide(2, 12, 3));
...
createFullName("Jocelyn", "Belden");

var fullName = createFullName("Jocelyn", "Belden");
...
console.log("eatFood: ", eatFood("Jocelyn", "Belden", "bacon"));
...
shoeSize(bango2);
console.log("shoeSize: ", shoeSize(bango2));
...
*/
 ...
 console.log(allCaps("oh my gosh"));
...
console.log("Can Drink? ", verifyDrinkingAge(30));
*/
